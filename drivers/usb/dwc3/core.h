...
{ ; }
static inline void dwc3_simple_wakeup_capable(struct device *dev, bool wakeup)
{ ; }
static inline void dwc3_set_simple_data(struct dwc3 *dwc)
{ ; }
static inline void dwc3_simple_check_quirks(struct dwc3 *dwc)
{ ; }
static inline int dwc3_set_usb_core_power(struct dwc3 *dwc, bool on)
{ return 0; }
#endif
